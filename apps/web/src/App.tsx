  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <header style={{ padding: '1rem', background: '#0f172a', color: '#fff', borderRadius: '8px' }}>
        <h2>BidMizan Ethical Procurement & Tender AI</h2>
        <p style={{ fontSize: '14px', color: '#94a3b8' }}>Ethical Procurement Fraud Detection, Bid Auditor & Fairness Score Engine</p>
      </header>
