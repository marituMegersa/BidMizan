...
import { TenderAuditForm } from './components/TenderAuditForm';
    ...
    <div style={{ background: '#f1f5f9', minHeight: '100vh', padding: '1.5rem', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      <div style={{ maxWidth: '1050px', margin: '0 auto' }}>
        ...
        <div style={{ marginTop: '1.5rem' }}>
          <ProcurementDashboard total={records.length} alerts={alerts} />
          <TenderAuditForm onSubmit={handleFormSubmit} />
